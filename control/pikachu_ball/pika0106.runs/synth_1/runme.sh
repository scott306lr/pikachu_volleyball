...
HD_PWD='C:/Users/Shlab_63/Desktop/github/dlab_pikachu_volleyball/control/pikachu_ball/pika0106.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab10.tcl
